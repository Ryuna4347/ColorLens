...
public class TouchUI : MonoBehaviour
{
    ...
    {
        if (PlayerPrefs.GetInt("TouchType", 1) == 0)
        {
    ...
    {
        if(PlayerPrefs.GetInt("TouchType", 1) == 1)
        {
    ...
    private void Update()
    {
        if (PlayerPrefs.GetInt("TouchType", 1) == 1 && !GameManager.instance.IsGameOver && GameManager.instance.CanMove)
        {
